        ...
        {items.map((item, idx) => (
          <li
            ...
            <blockquote>
              ...
              <span
                className="relative z-20 text-xl leading-[1.6] font-normal text-[#4F4F4F] dark:text-gray-100">
                {item.title}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span
                    className="text-sm leading-[1.6] font-normal text-[#656464] dark:text-gray-400">
                    {item.quote}
                  </span>
                  <span
                    className="text-sm leading-[1.6] font-normal text-[#4F4F4F] dark:text-gray-400">
                    {/* {item.title} */}
                  </span>
                </span>
              </div>
