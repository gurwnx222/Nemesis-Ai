...
export function DataFlowAnimation({ className }) {
  ...
  return (
    <div
      className={cn(
        'relative flex h-[250px] w-full items-center justify-center overflow-hidden rounded-lg bg-transparent  p-10',
        className
      )}
      ref={containerRef}
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          ...
          <Square ref={div7Ref}>
            {/* <Icons.user /> */}
            <Image src={threadIcon} alt="thread icon" />
          </Square>
        </div>
      </div>

      {/* Beams from sources to the processing unit */}
      ...
      {/* Beam from the processing unit to the user */}
      <AnimatedBeam
        containerRef={containerRef}
        fromRef={div6Ref}
        toRef={div7Ref}
